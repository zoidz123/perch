...
```sh
npm install --global perchctl@0.1.5
```
...
The pinned package for this source is `perchctl@0.1.5` and installs the `perch` executable plus both Darwin no-mistakes architectures.
