...
```sh
npm install --global perchctl@0.1.19
```
...
The pinned package for this source is `perchctl@0.1.19` and installs the `perch` executable plus the immutable bundled AutoReview skill and helper.
