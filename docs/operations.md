...
```sh
npm install --global perchctl@0.1.13
```
...
The pinned package for this source is `perchctl@0.1.13` and installs the `perch` executable plus both Darwin no-mistakes architectures.
