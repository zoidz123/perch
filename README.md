...
Perch was inspired by [Kun Chen's FirstMate](https://github.com/kunchenguid/firstmate) and its first-mate-and-crew model for coordinating isolated coding agents. Perch is a distinct Mac-hosted durable control plane with an iPhone client.
